...
############################################################################
class SVMClassifierRegion(PyRegion):
  """
  ...
  def getSpec(cls):
    ...
    """
    ns=dict(
      description=SVMClassifierRegion.__doc__,
      singleNodeOnly=True,
      inputs=dict(
        categoryIn=dict(
          dataType="Real32",
        ...
        bottomUpIn=dict(
          dataType="Real32",
          description="""Belief defaultValues over children's groups""",
          regionLevel=True,
          count=0,
          required=True,
          isDefaultInput=True,
      ...
      parameters=dict(
        ...
        C=dict(
          ...
          accessMode="Read",
          defaultValue = 0.0,
          description="""The current defaultValue of C, an SVM parameter that
                        influences the error rate. If numRecursions==0, this defaultValue is
                        used to build the SVM; otherwise, minC and maxC are used,
                        and this parameter is changed to the best defaultValue afterwards."""),
        minC=dict(
          dataType="float",
          constraints="",
          count=1,
          accessMode="Create",
          defaultValue = 0.0,
          description="""The minimum defaultValue of C, an SVM parameter that
                        influences the error rate. SVMClassifierNode will
                        perform an optimization process in order to find the
                        defaultValue of C that minimizes error
        ...
        maxC=dict(
          ...
          accessMode="Create",
          defaultValue = 0.0,
          description="""The maximum defaultValue of C, an SVM parameter that
        ...
        gamma=dict(
          ...
          accessMode="Read",
          defaultValue = 0.0,
          description="""The current defaultValue of gamma, an SVM parameter that
                        influences the error rate. If numRecursions==0, this defaultValue is
        ...
        minGamma=dict(
          ...
          accessMode="Create",
          defaultValue = 0.0,
          description="""The minimum defaultValue of Gamma, an SVM parameter that
                        influences the error rate.  SVMClassifierNode will perform an
                        optimization process in order to find the defaultValue of Gamma that
        ...
        maxGamma=dict(
          ...
          accessMode="Create",
          defaultValue = 0.0,
          description="""The maximum defaultValue of Gamma, an SVM parameter that
                        influences the error rate."""),
        kernelType=dict(
          dataType="Byte",
          constraints="string",
          ...
          accessMode="Create",
          defaultValue= "rbf",
          description="""Specifies the         dataType of kernel to use.  Valid choices
        ...
        numRecursions=dict(
          ...
          description="""The number of rounds of recursive Latin Hypercube Sampling
                        ...
                        performed, and instead the defaultValues 'minC' and 'minGamma' are used."""),
        numSamplesPerRecursion=dict(
          dataType="UInt32",
          constraints="",
          count=1,
          accessMode="ReadWrite",
        ...
        numCrossValidations=dict(
          ...
          description="""The number of cross validation steps
                        ...
                        set of C and Gamma defaultValues.  Increasing this number will yield
                        better error rate estimates, and hence more optimal defaultValues
        ...
        inputThresh=dict(
          ...
          accessMode="Create",
          defaultValue = 0.5,
          description="""A floating point defaultValue that establishes the threshold
        ...
        mode=dict(
          ...
          description="""We operate in two modes: 'classification' - the SVM is
                        ...
                        selection stage for pruning purposes.  The only difference is the
                        choice of kernel; for 'classification' mode, then kernel is selected
                        based on the defaultValue of the parameter 'kernelType'.  But in 'feedback'
                        mode, the kernel is always of         dataType 'linear' regardless of the defaultValue
                        of 'kernelType'."""),
        deterministic=dict(
          dataType="UInt32",
          constraints="bool",
        ...
        fractionOfMax=dict(
          ...
          accessMode="Create",
          defaultValue=None,
          description="""The smallest singular defaultValue which is retained
                        as a fraction of the largest singular defaultValue. This is used
